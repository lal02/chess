...
//    }
    ...
    public Position getPositionFromImageView(ImageView imageView){
        ...
        switch(imageView.getId()){
            case "A8" : return Position.A8;
            case "B8" : return Position.B8;
            case "C8" : return Position.C8;
            case "D8" : return Position.D8;
            case "E8" : return Position.E8;
            case "F8" : return Position.F8;
            case "G8" : return Position.G8;
            case "H8" : return Position.H8;
            case "A7" : return Position.A7;
            case "B7" : return Position.B7;
            case "C7" : return Position.C7;
            case "D7" : return Position.D7;
            case "E7" : return Position.E7;
            case "F7" : return Position.F7;
            case "G7" : return Position.G7;
            case "H7" : return Position.H7;
            case "A6" : return Position.A6;
            case "B6" : return Position.B6;
            case "C6" : return Position.C6;
            case "D6" : return Position.D6;
            case "E6" : return Position.E6;
            case "F6" : return Position.F6;
            case "G6" : return Position.G6;
            case "A5" : return Position.A5;
            case "B5" : return Position.B5;
            case "C5" : return Position.C5;
            case "D5" : return Position.D5;
            case "E5" : return Position.E5;
            case "F5" : return Position.F5;
            case "G5" : return Position.G5;
            case "H5" : return Position.H5;
            case "A4" : return Position.A4;
            case "B4" : return Position.B4;
            case "C4" : return Position.C4;
            case "D4" : return Position.D4;
            case "E4" : return Position.E4;
            case "F4" : return Position.F4;
            case "G4" : return Position.G4;
            case "H4" : return Position.H4;
            case "A3" : return Position.A3;
            case "B3" : return Position.B3;
            case "C3" : return Position.C3;
            case "D3" : return Position.D3;
            case "E3" : return Position.E3;
            case "F3" : return Position.F3;
            case "G3" : return Position.G3;
            case "H3" : return Position.H3;
            case "A2" : return Position.A2;
            case "B2" : return Position.B2;
            case "C2" : return Position.C2;
            case "D2" : return Position.D2;
            case "E2" : return Position.E2;
            case "F2" : return Position.F2;
            case "G2" : return Position.G2;
            case "H2" : return Position.H2;
            case "A1" : return Position.A1;
            case "B1" : return Position.B1;
            case "C1" : return Position.C1;
            case "D1" : return Position.D1;
            case "E1" : return Position.E1;
            case "F1" : return Position.F1;
            case "G1" : return Position.G1;
            case "H1" : return Position.H1;
        }
